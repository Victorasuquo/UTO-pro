...
def generate_readme(repository, context):
    """Generate a detailed README.md file based on repository and context."""
...
List and describe all API endpoints if applicable.
...
"""
    ...
    file_name = f"{name}_README.md"
    with open(file_name, "w") as file:
        file.write(readme_content)

    print(f"README.md file generated and saved as {file_name}.")
...
if __name__ == "__main__":
    ...
    generate_readme_choice = input("Do you want to generate a README.md file for the top matched repository? (y/N): ").lower() in ["yes", "y"]

    if generate_readme_choice and matched_repositories:
        generate_readme(matched_repositories[0], context)
